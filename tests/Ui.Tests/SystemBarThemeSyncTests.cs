...
/// <summary>
/// The native system bars follow the app's theme (2026-09-16, ported from JiggerJot). On Android the status
/// bar is drawn by the OS, not the page, so it kept one hard-coded green whatever the theme — over the dark
/// page ground of the sign-in screen as over the light one, and in every downstream app that restyled its header.
