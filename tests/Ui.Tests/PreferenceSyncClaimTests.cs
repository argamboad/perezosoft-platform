...
/// signed out (found downstream: JiggerJot's develop run 35128350182). So the service remembers the saved
/// value beside the token instead: no request, nothing to race.
/// </para>
/// </summary>
